        ...
        <div id="content">
            ...
            <?php
                if (isset($_SESSION['user_id'])):
                    $searchString=$_GET['section'];
                    ?>
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Displaying Code for <?=$searchString?></h1>

                <?php
                foreach(glob(getcwd().'/*.php') as $file) {
                    $name = pathinfo($file, PATHINFO_FILENAME);
                    $end = ".php";
                    if(strpos(strtolower($name), strtolower($searchString)) !== false) {
                        echo "<h3>File Name: $name$end</h3>";

                        highlight_file($name.$end);
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>FIT2104 &copy; Assignment 2 2020</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
