        ...
        <div id="content">
            ...
            <?php
                ...
                if (empty($_POST["project_name"])) { ?>
                    Project Id <br/> <input type="text" name = "project_id" value = "<?= $row -> project_id; ?>" disabled/><br/>
                    Client Id <br/> <input type="text" name = "client_id" value = "<?= $row -> client_id; ?>" disabled><br/>
                    Project Name <br/> <input type="text" name = "project_name" value = "<?= $row -> project_name; ?>" disabled><br/>
                    Description <br/> <input type="text" name = "project_desc" value = "<?= $row -> project_desc; ?>" disabled><br/>
                    Address <br/> <input type="text" name = "project_addr" value = "<?= $row -> project_addr; ?>" disabled><br/>
                    Quote <br/> <input type="text" name = "project_quote" value = "<?= $row -> project_quote; ?>" disabled><br/>
                    Other Information </br><textarea name="project_other_info" disabled><?php echo $row -> project_other_info; ?></textarea><br/><br/>
                    <button type="button" style="float: right" class="btn btn-primary btn-icon-split" onclick="location.href='project.php'">
