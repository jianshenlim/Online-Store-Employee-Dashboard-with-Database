...
<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <!-- Main Content -->
    <div id="content" style="background-image: url('css/beatriz-perez-moya-M2T1j-6Fn8w-unsplash.jpg'); opacity: 70%;">
      ...
      <div class="container-fluid">
        ...
        <div class="row justify-content-center">
          ...
          <div style="vertical-align: middle; text-align: center" class="col-xl-4 col-lg-5">
            <div class="card o-hidden border-0 shadow-lg my-5">
              <div style="vertical-align: middle; text-align: center" class="card-body">
                <!-- Nested Row within Card Body -->
                    Master of Wedding Administrative System<br>
                      Today's Date is: <br>
