        ...
        <div id="content">
            ...
            if (isset($_SESSION['user_id'])):?>
                ...
                <div class="card shadow mb-4">
                        ...
                        <div class="table-responsive">
                                <?php
                                   $query = "SELECT * FROM `user` order by user_id asc";
                                    ...
                                    if(!$stmt ->execute()){
                                        $err = $stmt->errorInfo();
                                        echo "<script>alert('Error user from database - contact System Administrator Error is: $err[2]')</script>";
                                                    ...
                                                    <?php while($row = $stmt -> fetchObject()): ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center; vertical-align: middle">
                                                                ...
                                                                <a href="deleteUser.php?delUserId=<?php echo $row -> user_id; ?>"class="btn btn-danger btn-circle" title="Delete User">
                    ...
                    <a href="addUser.php" style="float: right" class="btn btn-sm btn-primary btn-icon-split">
                            <span class="icon text-white-50">
                              <i class="fas fa-plus"></i>
                            </span>
                        <span class="text">Register New User</span>
                    </a>
