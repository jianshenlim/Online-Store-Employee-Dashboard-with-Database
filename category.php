        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                    ...
                    <a href="addCategory.php" style="float: right" class="btn btn-sm btn-primary btn-icon-split">
                                            ...
                                            <?php  while($row = $stmt -> fetchObject()): ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; vertical-align: middle">
                                                        <a href="product.php?cat=<?php echo $row->category_name;?>" class="btn btn-primary btn-circle" title="View Products">
                                                            <i class="fas fa-list-ul"></i>
                                                        </a>
                                                        <a href="editCategory.php?id=<?php echo $row->category_id;?>" class="btn btn-info btn-circle" title="Edit Category">
                                                            <i class="fas fa-pencil-alt" ></i>
                                                        </a>
                                                        <a href="deleteCategory.php?id=<?php echo $row->category_id;?>"class="btn btn-danger btn-circle" title="Delete Category">
