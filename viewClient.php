    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <?php
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">View Client</h1>
            ...
            if (empty($_POST["client_fname"])) { ?>
                ...
                <button type="button" style="float: right" class="btn btn-primary btn-icon-split" onclick="location.href='client.php'">
